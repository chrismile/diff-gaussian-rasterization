...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        args = (
            ...
            raster_settings.use_gradients
        )

        # Invoke C++/CUDA rasterizer
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, gradients, invdepths = _C.rasterize_gaussians(*args)
        ...
        return color, radii, gradients, invdepths

    @staticmethod
    def backward(ctx, grad_out_color, _1, _2, grad_out_depth):
